@extends('admin.layouts.app', ['activePage' => 'yurt-management', 'titlePage' => __('Yurt Ekle')])
...
@section('content')
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('admin.yurtlar.store') }}" enctype="multipart/form-data" class="form-horizontal">
            @csrf
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Yurt Ekle') }}</h4>
                <p class="card-category">{{ __('Yeni bir yurt ekleyin') }}</p>
              </div>
              <div class="card-body">
                <div class="row mb-3 ">
                  <label class="col-sm-1 col-form-label bg-success text-white h-50 rounded mb-3">İsim</label>
                  <div class="col-sm-5 mb-3">
                    <input type="text" class="form-control" name="isim" placeholder="Yurt İsmi" required>
                  </div>
                  <label class="col-sm-1 col-form-label bg-success text-white h-50 rounded mb-3">Yurt Tipi</label>
                  <div class="col-sm-5 mb-3">
                    <input type="text" class="form-control" name="yurt_tipi" placeholder="Yurt Tipi">
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-1 col-form-label bg-success text-white h-50 rounded mb-3">Ücret</label>
                  <div class="col-sm-5 mb-3">
                    <input type="number" class="form-control" name="ucret" placeholder="Ücret">
                  </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-11 mb-3">
                    <textarea class="form-control" name="adres" placeholder="Adres"></textarea>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-5 mb-3">
                    <textarea class="form-control" name="kayit_icin_belgeler" placeholder="Kayıt İçin Belgeler"></textarea>
                  </div>
                  <label class="col-sm-1 col-form-label  bg-success text-white h-50 rounded mb-3">Yurt Başvurusu</label>
                  <div class="col-sm-5 mb-3">
                    <textarea class="form-control" name="yurt_basvurusu" placeholder="Yurt Başvurusu"></textarea>
                  </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-2 border p-3 mb-3">
                        <div class="radio-group">
                            <input class="radio-input" type="radio" name="cinsiyet" id="cinsiyet_erkek" value="Erkek">
                        ...
                        <div class="radio-group mt-2">
                            <input class="radio-input" type="radio" name="cinsiyet" id="cinsiyet_kadin" value="Kız">
